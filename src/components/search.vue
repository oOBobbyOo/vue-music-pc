...
<script>
import searchSong from './searchType/searchSong'
import searchSinger from './searchType/searchSinger'
import searchAlbum from './searchType/searchAlbum'
import searchSongList from './searchType/searchSongList'
